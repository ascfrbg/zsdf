...
UUID=${UUID:-'5ab1f234-9dc1-4d0d-8832-ed58dd9b18cb'}
VMESS_WSPATH=${VMESS_WSPATH:-'/46d465be-4551-413a-b9c6-34710b272a9f-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/5a6d5c62-5f59-4972-b3bb-efae8ec1aa8d-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/836868dd-ea05-460b-a24f-987aebfe2f1c-trojan'}
SS_WSPATH=${SS_WSPATH:-'/e47a42a6-067c-4e8f-a2d6-ecf1d240a056-shadowsocks'}
